...
private:
    ...
    //
    // **NOT MEASURED IN THIS TREE.** This fork is 250 bar over a 1500 K melt with a 300 km shell at 5.06 scale
    // heights, and its README item 69 is where the defect was found -- but no A/B has been run
    // here since, and every Psi figure in that README predates this flip. The A/B is queued.
    // ==================================================================
