...
void cAtmosphereModel::initComposition(){
    ...
    // Composition-weighted background opacity (README item 60). One number, because the six
    // background gases are in fixed proportion.
...
// README item 39 has the measurement; this is the check that keeps it visible.
//
